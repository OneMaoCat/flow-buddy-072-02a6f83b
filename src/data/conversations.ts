  ...
  const conversations: Conversation[] = [
    {
      ...
      messages: [{ id: "msg-1", text: "修复登录表单验证 Bug，增加邮箱和密码格式校验", timestamp: Date.now() - 600_000 }],
      tasks: [task1],
      devInProgress: true,
    ...
    },
    {
      ...
      messages: [
        { id: "msg-2", text: "重构订单模块支付流程，支持微信和支付宝", timestamp: Date.now() - 7200_000 },
        { id: "msg-3", text: "再加一个订单状态流转的功能", timestamp: Date.now() - 3600_000 },
      ],
      tasks: [task2, task3],
      devInProgress: false,
    ...
    },
    {
      ...
      messages: [{ id: "msg-4", text: "优化用户权限管理模块，支持角色分配", timestamp: Date.now() - 86400_000 }],
      tasks: [],
      devInProgress: false,
